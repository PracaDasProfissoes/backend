...
public enum Privilege implements Serializable {
	...
	//Educational Agents
	I_EA(PrivilegeUtils.I_EA, "INDEX_EDUCATIONAL_AGENTS", "Visualizar todos os agentes educacionais", PrivilegeUtils.EA),
	S_EA(PrivilegeUtils.S_EA, "SHOW_EDUCATIONAL_AGENT", "Detalhes do agente educacional", PrivilegeUtils.EA),
	C_EA(PrivilegeUtils.C_EA, "CREATE_EDUCATIONAL_AGENT", "Criar agente educacional", PrivilegeUtils.EA),
	U_EA(PrivilegeUtils.U_EA, "UPDATE_EDUCATIONAL_AGENT", "Atualizar agente educacional", PrivilegeUtils.EA),
	D_EA(PrivilegeUtils.D_EA, "DELETE_EDUCATIONAL_AGENT", "Deletar agente educacional", PrivilegeUtils.EA),
	...
	// Educational Agent
	public static final String INDEX_EDUCATIONAL_AGENT = PrivilegeUtils.I_EA;
	public static final String SHOW_EDUCATIONAL_AGENT = PrivilegeUtils.S_EA;
	public static final String CREATE_EDUCATIONAL_AGENT = PrivilegeUtils.C_EA;
	public static final String UPDATE_EDUCATIONAL_AGENT = PrivilegeUtils.U_EA;
	public static final String DELETE_EDUCATIONAL_AGENT = PrivilegeUtils.D_EA;
...
class PrivilegeUtils {
	...
	static final String EA = "Agentes Educacionais";
	...
	//Educational Agent
	static final String I_EA = "I_EA";
	static final String S_EA = "S_EA";
	static final String C_EA = "C_EA";
	static final String U_EA = "U_EA";
	static final String D_EA = "D_EA";
